...
public class Runner {
	public static void main(String[] args) {
		String[] names = { "LinkedList Add ", "ArrayList Add ", "HashSet Add ", "TreeSet Add ", "LinkedList Search ",
				"ArrayList Search ", "HashSet Search ", "TreeSet Search ", "LinkedList Remove ", "ArrayList Remove ",
				"HashSet Remove ", "TreeSet Remove " };
		...
		data[7].put(CollectionMod.search(ts, 201), ts);
		for (int i = 4; i < 8; i++) {
			map.put(names[i], data[i]);
		}
