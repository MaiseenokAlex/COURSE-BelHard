...
public static void main(String[] args) {
	...
	stc1.add(wd2);
	System.out.println("stc1.toString() after adding: \n"+stc1);
	stc1.remove(1);
	System.out.println("stc1.toString() after removing: \n"+stc1);
	System.out.println("stc1.equals(stc2): "+stc1.equals(stc2));
	System.out.println();
	...
	tx2.add(stc2);
	System.out.println("tx2.toString() after adding: \n"+tx2);
	tx2.remove(stc2);
	System.out.println("tx2.toString() after removing: \n"+tx2);
}
}
